...
# Define the comprehensive textbook data
new_textbook = '''
export const textbookUnits: TextbookUnit[] = [
  ...
  { id: "tb-4-6", publisher: "部编版", grade: "四年级下", unit: "第二单元", lesson: "琥珀", characters: ["琥","珀","脂","渗","俯","渗","澎","湃","黏","稠","推测"], focus: "自然科学说明文" },
  ...
  { id: "tb-5-4", publisher: "部编版", grade: "五年级上", unit: "第四单元", lesson: "少年中国说", characters: ["泻","潜","渊","胎","履","疆","鳞","惶","胎","履","懈","纵"], focus: "思辨议论类用字" },

  // ========== 五年级下册 ==========
  { id: "tb-5-5", publisher: "部编版", grade: "五年级下", unit: "第一单元", lesson: "古诗三首", characters: ["昼","耘","桑","晓","漪","稚","陂","寒","漪","供","耕","织"], focus: "田园古诗常用字" },
...
export const studyPlanTemplates: StudyPlanTemplate[] = [
  // ===== 幼儿园阶段 =====
  {
    ...
    title: "小班启蒙计划（3-4岁）",
    audience: "幼儿园小班 3-4岁",
    dailyTarget: "每天 3-5 个生活常用字（人、口、手、大、小）",
    reviewMode: "每 2 天用看图识字游戏复习一次；每周循环复习本周 15 个字",
    parentControl: "家长可手动添加本周重点字；不限时长；无计分无惩罚；纯兴趣驱动"
  },
  {
    id: "kindergarten-4",
    title: "中班进阶计划（4-5岁）",
    audience: "幼儿园中班 4-5岁",
    dailyTarget: "每天 5-8 个字（动植物、颜色、方位、简单动词）",
    reviewMode: "每 3 天用场景找字游戏复习；用象形动画加深字形记忆",
    parentControl: "家长可设置每日学习上限（建议 15 分钟）；可添加课外字"
  },
  {
    id: "kindergarten-5",
    title: "大班衔接计划（5-6岁）",
    audience: "幼儿园大班 5-6岁",
    dailyTarget: "每天 8-10 个字，为小学一年级做学前铺垫",
    reviewMode: "每 5 天综合复习一次（听音选字 + 组词闯关）",
    parentControl: "可开启拼音认读辅助；可提前设置一年级上册生字表"
  },
  ...
  // ===== 小学低年级 =====
  {
    ...
    title: "一年级同步巩固计划",
    audience: "小学一年级",
    dailyTarget: "每天 8-12 个课文同步生字",
    reviewMode: "当天听读音 + 次日描红 + 周末错字复盘",
    parentControl: "可设置每日学习时长（建议 20 分钟）；可选择部编版/人教版版本"
  },
  {
    id: "grade2-plan",
    title: "二年级识写提升计划",
    audience: "小学二年级",
    dailyTarget: "每天 10-15 个生字，重点掌握偏旁部首",
    reviewMode: "部首找朋友游戏 + 组词闯关 + 看句选字",
    parentControl: "可开启笔顺检测；可设置薄弱单元专项练习"
  },
  {
    id: "unit-review",
    title: "单元专项复习计划",
    audience: "小学 1-2 年级",
    dailyTarget: "按单元同步复习课文生字",
    reviewMode: "形近字辨析 + 多音字初识 + 语段填空混合复习",
    parentControl: "可选择薄弱单元或本学期全部单元专项复习"
  },
  ...
  // ===== 小学中年级 =====
  {
    ...
    title: "三年级阅读拓展计划",
    audience: "小学三年级",
    dailyTarget: "每天 12-15 个字，侧重阅读理解和段落用字",
    reviewMode: "语段找字 + 近义词配对 + 多音字闯关",
    parentControl: "可指定课文篇目；可开启成语积累小任务"
  },
  {
    id: "grade4-plan",
    title: "四年级表达运用计划",
    audience: "小学四年级",
    dailyTarget: "每天 15-18 个字，侧重形近字辨析和成语积累",
    reviewMode: "形近字找茬 + 成语填字 + 说明文关键词语境辨字",
    parentControl: "可生成易错字专属练习册；可设置期末冲刺模式"
  },
  {
    id: "mid-term-review",
    title: "期中/期末总复习计划",
    audience: "小学 3-4 年级",
    dailyTarget: "按单元、按题型分类复习半学期所学字词",
    reviewMode: "多音字闯关 + 语段辨字 + 成语识字综合复习",
    parentControl: "可自动生成错题本和薄弱字清单；可设置复习天数"
  },
  ...
  // ===== 小学高年级 =====
  {
    ...
    title: "五年级综合素养计划",
    audience: "小学五年级",
    dailyTarget: "每天 15-20 个字，结合长文阅读和古诗文",
    reviewMode: "词义推断 + 古诗词填字 + 主题词归类 + 说明文专项",
    parentControl: "可设置阅读篇目同步；可监控易错字变化曲线"
  },
  {
    id: "grade6-plan",
    title: "六年级毕业冲刺计划",
    audience: "小学六年级",
    dailyTarget: "每天 18-22 个字，覆盖小学全部核心字词",
    reviewMode: "多音字闯关 + 易错字专项 + 整本书阅读词库 + 毕业模拟",
    parentControl: "可查看毕业掌握率报告；可自动生成薄弱字周计划"
  },
  {
    id: "graduate-review",
    title: "小升初衔接复习计划",
    audience: "小学六年级毕业",
    dailyTarget: "按知识点分类复习小学阶段所有重点汉字",
    reviewMode: "综合闯关 + 易错字大盘点 + 课外拓展识字",
    parentControl: "可开启初中预备字库；可生成毕业学情总报告"
  },
  ...
  // ===== 幼儿园自定义 =====
  {
    ...
    title: "自定义启蒙计划",
    audience: "幼儿园（全年龄段）",
    dailyTarget: "家长可自由设置每日识字量（1-15 字）",
    reviewMode: "自动按记忆曲线安排复习；支持象形、场景、听音多种模式",
    parentControl: "可手动添加重点学习汉字；可设置每周学习天数；无强制时长"
  },
  {
    id: "custom-primary",
    title: "自定义同步计划",
    audience: "小学 1-6 年级（全年级）",
    dailyTarget: "可设置每日新学字数和复习字数比例",
    reviewMode: "支持按课文、单元、薄弱字三种模式自动生成复习题",
    parentControl: "可绑定教材版本和年级；可设置每日学习提醒时间"
  }
]'''

# Find and replace textbookUnits section
start_marker = 'export const textbookUnits: TextbookUnit[] = ['
end_marker = ']\\n\\nexport const studyPlanTemplates'

# Use regex to find the exact locations
pattern_start = r'export const textbookUnits: TextbookUnit\[\] = \['
pattern_end = r'\]\n\nexport const studyPlanTemplates'
...
if match:
    ...
    if end_match:
        ...
        # Replace the textbook units section
        new_content = content[:start_pos] + new_textbook + '\n' + content[end_pos:]
        
        # Now replace the study plans section
        plans_start = r'export const studyPlanTemplates: StudyPlanTemplate\[\] = \['
        plans_end = r'\]'
        
        plans_match = re.search(plans_start, new_content)
        if plans_match:
            plans_start_pos = plans_match.start()
            # Find the matching closing bracket - find the first ] after the study plan start
            after_plans = new_content[plans_start_pos:]
            depth = 0
            plans_end_pos = -1
            for i, c in enumerate(after_plans):
                if c == '[':
                    depth += 1
                elif c == ']':
                    depth -= 1
                    if depth == 0:
                        plans_end_pos = plans_start_pos + i + 1
                        break
            
            if plans_end_pos > 0:
                new_content = new_content[:plans_start_pos] + new_plans + new_content[plans_end_pos:]
        
        with open(os.path.join(root, 'src/supportData.ts'), 'w', encoding='utf-8') as f:
            f.write(new_content)
        print('Updated supportData.ts successfully!')
    else:
