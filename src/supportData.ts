...
export const studyPlanTemplates: StudyPlanTemplate[] = [
  { id: 'kinder-3', title: '小班启蒙计划（3-4岁）', audience: '幼儿园小班 3-4岁', dailyTarget: '每天 3-5 个生活常用字', reviewMode: '每 2 天用看图识字游戏复习一次；每周循环复习', parentControl: '家长可手动添加本周重点字；不限时长；无计分无惩罚' },
  { id: 'kinder-4', title: '中班进阶计划（4-5岁）', audience: '幼儿园中班 4-5岁', dailyTarget: '每天 5-8 个字（动植物、颜色、方位、动词）', reviewMode: '每 3 天用场景找字游戏复习；用象形动画加深记忆', parentControl: '家长可设置每日学习上限（建议15分钟）；可添加课外字' },
  { id: 'kinder-5', title: '大班衔接计划（5-6岁）', audience: '幼儿园大班 5-6岁', dailyTarget: '每天 8-10 个字，为小学一年级做学前铺垫', reviewMode: '每 5 天综合复习（听音选字 + 组词闯关）', parentControl: '可开启拼音认读辅助；可提前设置一年级上册生字表' },
  { id: 'g1-plan', title: '一年级同步巩固计划', audience: '小学一年级', dailyTarget: '每天 8-12 个课文同步生字', reviewMode: '当天听读音 + 次日描红 + 周末错字复盘', parentControl: '可设置每日学习时长（建议20分钟）；可选择部编版' },
  ...
  { id: 'unit-review', title: '单元专项复习计划', audience: '小学1-2年级', dailyTarget: '按单元同步复习课文生字', reviewMode: '形近字辨析 + 多音字初识 + 语段填空混合复习', parentControl: '可选择薄弱单元或本学期全部单元专项复习' },
  ...
  { id: 'midterm-review', title: '期中期末总复习计划', audience: '小学3-4年级', dailyTarget: '按单元、按题型分类复习半学期所学字词', reviewMode: '多音字闯关 + 语段辨字 + 成语识字综合复习', parentControl: '可自动生成错题本和薄弱字清单；可设置复习天数' },
  ...
  { id: 'custom-kinder', title: '自定义启蒙计划', audience: '幼儿园全年龄段', dailyTarget: '家长可自由设置每日识字量（1-15字）', reviewMode: '自动按记忆曲线安排复习；支持象形、场景、听音多种模式', parentControl: '可手动添加重点学习汉字；可设置每周学习天数；无强制时长' },
  { id: 'custom-primary', title: '自定义同步计划', audience: '小学1-6年级全年级', dailyTarget: '可设置每日新学字数和复习字数比例', reviewMode: '支持按课文、单元、薄弱字三种模式自动生成复习题', parentControl: '可绑定教材版本和年级；可设置每日学习提醒时间' },
  ...
  { id: 'tb-2-1', publisher: '部编版', grade: '二年级上', unit: '课文一', lesson: '小蝌蚪找妈妈', characters: ['两','哪','宽','顶','眼','睛','肚','皮','孩','跳','变','条'], focus: '动物故事中的形声字' },
  ...
  { id: 'tb-2-5', publisher: '部编版', grade: '二年级上', unit: '课文三', lesson: '曹冲称象', characters: ['称','柱','底','杆','秤','做','岁','站','船','然','量'], focus: '历史故事中的量词' },
  ...
  { id: 'tb-4-1', publisher: '部编版', grade: '四年级上', unit: '第一单元', lesson: '观潮', characters: ['潮','据','堤','阔','笼','罩','盼','滚','顿','逐','渐','犹','震','霎','余'], focus: '写景文章观察和动态描写字' },
  ...
  { id: 'tb-5-3', publisher: '部编版', grade: '五年级上', unit: '第三单元', lesson: '猎人海力布', characters: ['酬','誓','谎','嫂','罕','纱','妻','趟','托','泳','婚','辈'], focus: '民间故事角色和动作词' },
  ...
  { id: 'tb-6-2', publisher: '部编版', grade: '六年级上', unit: '第二单元', lesson: '七律长征', characters: ['逶','迤','磅','礴','丸','岷','崖','渡','索','攀','诞','典'], focus: '革命诗词用字' },
